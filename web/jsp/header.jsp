            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a href="${loginURL ne null ? loginURL : "#"}" class="dropdown-toggle" data-toggle="${loginURL eq null ? "dropdown" : "" }" role="button" aria-haspopup="true" aria-expanded="false">${loginURL eq null ? user.nickname : "Sign In" }<span class="caret"></span></a>
                            <ul class="dropdown-menu">
