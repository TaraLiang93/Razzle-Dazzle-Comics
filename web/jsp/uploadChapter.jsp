...
<div class="modal fade" id="uploadChapterModal" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <form id="uploadForm" method="post" action="${uploadChapterAction}" enctype="multipart/form-data" style="height:100%; width:100%;">
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="submit" class="btn btn-primary"  id="saveChapter" onclick="$('#uploadChapterModal').modal('hide');$('#uploadForm').submit();">Save</input>
                    </div>
            </form>
        </div>
    </div>
